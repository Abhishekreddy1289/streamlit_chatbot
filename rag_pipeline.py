...
class RAG:
    ...
    def insert_doc(self, file_path, file_name):
        try:
            ...
            for doc in docs:
                self.docsearch.add_documents([doc])
...
If the answer is extracted from multiple sources, please list all the document names and page numbers from which the information is drawn.
